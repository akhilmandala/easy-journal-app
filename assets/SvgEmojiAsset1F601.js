...
const SvgSvgEmojiAsset1F601 = (props) => (
  <svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g fill="none" stroke="#000" strokeLinecap="round" strokeWidth={2}>
      ...
      <path
        strokeMiterlimit={10}
        d="M31.694 32.404a4.726 4.726 0 0 0-8.638 0M48.944 32.404a4.726 4.726 0 0 0-8.638 0"
      />
    </g>
  </svg>
);

export default SvgSvgEmojiAsset1F601;
