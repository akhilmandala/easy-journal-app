...
const SvgSvgEmojiAsset1F60E = (props) => (
  <svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    >
      ...
      <path d="m18.953 29.93-.433-3.37 3.833-.528M52.741 30.464s.953 8.55-6.86 7.918c-2.62-.212-7.817-.65-7.868-8.342-.004-.698.008-1.6.811-2.63 1.065-1.367 3.572-1.971 9.945-1.422 0 0 3.446-.1 3.972 4.476z" />
      <path d="M31.505 26.416s4.124 2.534 8.657 0M33.536 31.318s2.202-3.751 4.536 0M52.664 29.933l.433-3.371-3.833-.528" />
      <path d="M33.955 30.027s1.795-3.75 3.699 0" />
    </g>
  </svg>
);

export default SvgSvgEmojiAsset1F60E;
